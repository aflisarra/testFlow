...
class GeneratePlanRequest(BaseModel):
    ...
    style_config: str | None = Field(
        default=None, description="UI style config (colors, shapes, fonts...)"
    )
    project_title: str | None = Field(
        default=None, description="Optional project name/title (context only)"
    )
    project_id: str | None = Field(default=None, description="Optional project id (context only)")
    test_suite_id: str | None = Field(
        default=None, description="Optional test suite id used for cancellation scope"
    )
    spec_hash: str | None = Field(default=None, description="Uploaded specification hash")
    generation_scope: str | None = Field(
        default="plans", description="Optional generation scope for cancellation"
    )
    generation_request_id: str | None = Field(
        default=None, description="Optional generation request id used for cancellation"
    )
