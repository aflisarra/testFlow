...
def build_test_case_prompt(
    *,
    ...
    return (
        ...
        "exists (e.g. a documented status, date, or type). Otherwise INVENT a plausible, realistic, clearly-sample concrete value "
        "appropriate to the field's semantic type — e.g. a role field -> \"Admin\", a name field -> \"John Doe\", a date field -> "
        "\"2026-05-01\", an email field -> \"john.doe@example.com\", a phone field -> \"+1-555-0134\". Never use vague generic "
        "phrasing such as \"a valid employee name\" or \"a valid X\", and never use the literal placeholder text \"example value\".\n"
