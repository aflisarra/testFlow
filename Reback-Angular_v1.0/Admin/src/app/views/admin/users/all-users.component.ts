...
export class AllUsersComponent implements OnInit {
  ...
  submitCreateUser(): void {
    ...
    if (!this.canAddUser) {
      this.notifyPermissionDenied('Unauthorized action: Add User.')
      return
    }
  ...
  onEditUser(user: AppUser) {
    if (!this.canEditUser) {
      this.notifyPermissionDenied('Unauthorized action: Edit User.')
      return
    }
  ...
  onDeleteUser(user: AppUser) {
    if (!this.canDeleteUser) {
      this.notifyPermissionDenied('Unauthorized action: Delete User.')
      return
    }
